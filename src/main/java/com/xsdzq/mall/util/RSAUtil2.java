...
public class RSAUtil2 {
	...
	public static void main(String[] args) throws Exception {
		...
		// encrypt the message
		String encrypted = encrypt(privateKey, "love me d将阿里斯顿结果salejglajsglkjaslkjglka  将阿里斯顿结果了ajljaljslkfajslkfj  jaljfaljflsajlfs jlajsflsajlkf lajflkajlkfjaljffffjlajfljlfjaljflasssssssssssssssssssssssssssssssssssssssssssssssssssssssssLafjlkfjlk");
		System.out.println(encrypted); // <<encrypted message>>

		// decrypt the message
		String secret = decrypt(publicKey, encrypted);
